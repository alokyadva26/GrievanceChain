          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4 border-b border-slate-800/50 pb-4">
            ...
            <div className="flex gap-2 p-1 bg-slate-900 border border-slate-800 rounded-xl overflow-x-auto w-full sm:w-auto">
              ...
              {statusFilters.map((f) => (
                <button
                  key={f.value}
                  className={`whitespace-nowrap px-4 py-1.5 rounded-lg text-sm font-semibold transition-all ${filter === f.value ? "bg-slate-700 text-white shadow" : "text-slate-400 hover:text-slate-300 hover:bg-slate-800"
                    }`}
